# Contributing to Gaan

Thank you for your interest in contributing to Gaan! This document provides comprehensive guidelines and information for contributors.
...
3. Add the upstream repository:
   ```bash
   git remote add upstream https://github.com/rumman2004/Gaan.git
   ```
...
2. Add Android apps with package names:
   - `rumman2004.echo.music` (release)
   - `rumman2004.echo.music.debug` (debug)
...
When contributing to Gaan, it's crucial to handle sensitive information properly:
...
./gradlew test --tests "rumman2004.echo.MusicPlayerTest"
...
1. Check the [GitHub Discussions](https://github.com/rumman2004/Gaan/discussions)
...
Thank you for contributing to Gaan!
