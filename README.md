...
Gaan delivers a seamless, premium listening experience by leveraging YouTube Music's vast library — without the ads. It adds powerful extras including offline downloads, real-time synchronized lyrics, and environment-aware music recognition.
...
### What's New
- **Lossless Music Hub** — Stream and contribute 16-bit/24-bit FLAC files directly to the Gaan ecosystem.
...
Download the latest pre-compiled APK from the [Releases Page](https://github.com/rumman2004/Gaan/releases/latest).

### Building from Source

1. **Clone the Repository**
   ```bash
   git clone https://github.com/rumman2004/Gaan.git
   cd Echo-Music
   ```
...
4. **Build the Application**
   Gaan has two build variants: **FOSS** (without Google Play Services / Cast) and **GMS** (with Cast support).
...
<h3>We use Weblate to translate Gaan. <a href="https://hosted.weblate.org/projects/echo-music/">Help us bring Gaan to more people!</a></h3>
...
Gaan stands on the shoulders of several excellent open-source projects. Sincere thanks to:
